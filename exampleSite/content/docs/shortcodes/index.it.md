...
Admonition serves a similar purpose as the alert shortcode but is implemented via Hugo render hooks. Its usage resembles [GitHub alerts](https://github.com/orgs/community/discussions/16925):
