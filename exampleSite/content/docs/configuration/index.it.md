...
| `hotlinkPrefixes` |  _Not set_ | Hotlink external images by URL prefix. Matching URLs are used directly; others are fetched via Hugo. Example: `["https://example-cdn.com/", "https://assets.example.com/img/"]` |
